    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: '#FFF8F0' }}>
      ...
      <div className="flex gap-8">
        <button
          ...
          className="flex flex-col items-center gap-4 p-8 rounded-3xl bg-white shadow-lg hover:shadow-xl transition-all hover:scale-105 active:scale-95"
          style={{ minWidth: 200 }}
        >
          <div
          ...
          <span className="text-2xl font-bold" style={{ color: '#F472B6' }}>Candie</span>
        </button>
        ...
        >
          ...
          <span className="text-2xl font-bold" style={{ color: '#60A5FA' }}>Will</span>
        </button>
      </div>
    </div>
  );
